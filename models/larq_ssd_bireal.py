...
from tensorflow.keras.layers import Input, Lambda, Conv2D, MaxPooling2D, BatchNormalization, ELU, Reshape, Concatenate, Activation, Add, AveragePooling2D
...
kwargs = dict(input_quantizer="approx_sign",
...
def build_model(image_size,
    ...
    #1ST LAYER STARTS HERE
    conv1 = Conv2D(32, (7, 7), strides=(2, 2), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv1')(x1)
    ...
    conv2 = QuantConv2D(32, (3, 3), strides=(1, 1), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv2', **kwargs)(pool1)
    conv2 = BatchNormalization(axis=3, momentum=0.99, name='bn2')(conv2)
    add2 = Add()([pool1, conv2])

    conv3 = QuantConv2D(32, (3, 3), strides=(1, 1), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv3', **kwargs)(add2)
    conv3 = BatchNormalization(axis=3, momentum=0.99, name='bn3')(conv3)
    add3 = Add()([add2, conv3])

    conv4 = QuantConv2D(32, (3, 3), strides=(1, 1), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv4', **kwargs)(add3)
    conv4 = BatchNormalization(axis=3, momentum=0.99, name='bn4')(conv4)
    add4 = Add()([add3, conv4])

    conv5_1 = QuantConv2D(64, (3, 3), strides=(2, 2), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv5_1', **kwargs)(add4)
    conv5_1 = BatchNormalization(axis=3, momentum=0.99, name='bn5_1')(conv5_1)
    
    conv5_2 = AveragePooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool5_2')(add4)
    conv5_2 = Conv2D(64, (1, 1), strides=(1, 1), padding='valid', use_bias=False, kernel_initializer='glorot_normal', name='conv5_2')(conv5_2)
    conv5_2 = BatchNormalization(axis=3, momentum=0.99, name='bn5_2')(conv5_2)
    add5 = Add()([conv5_1, conv5_2])
    
    conv6 = QuantConv2D(64, (3, 3), strides=(1, 1), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv6', **kwargs)(add5)
    conv6 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool6')(conv6)
    conv6 = BatchNormalization(axis=3, momentum=0.99, name='bn6')(conv6)
    
    conv7 = QuantConv2D(48, (3, 3), strides=(1, 1), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv7', **kwargs)(conv6)
    conv7 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool7')(conv7)
    conv7 = BatchNormalization(axis=3, momentum=0.99, name='bn7')(conv7)
    
    conv8 = QuantConv2D(48, (3, 3), strides=(1, 1), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv8', **kwargs)(conv7)
    conv8 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool8')(conv8)
    conv8 = BatchNormalization(axis=3, momentum=0.99, name='bn8')(conv8)
    
    conv9 = QuantConv2D(48, (3, 3), strides=(1, 1), padding="same", use_bias=False, kernel_initializer='glorot_normal', name='conv9', **kwargs)(conv8)
    conv9 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool9')(conv9)
    ...
    classes4 = Conv2D(n_boxes[0] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes4')(conv6)
    classes5 = Conv2D(n_boxes[1] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes5')(conv7)
    classes6 = Conv2D(n_boxes[2] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes6')(conv8)
    classes7 = Conv2D(n_boxes[3] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes7')(conv9)
    # Output shape of `boxes`: `(batch, height, width, n_boxes * 4)`
    boxes4 = Conv2D(n_boxes[0] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes4')(conv6)
    boxes5 = Conv2D(n_boxes[1] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes5')(conv7)
    boxes6 = Conv2D(n_boxes[2] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes6')(conv8)
    boxes7 = Conv2D(n_boxes[3] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes7')(conv9)
